...
class DeformableRegistration(EMRegistration):
    ...
    def __init__(self, alpha=None, beta=None, *args, **kwargs):
        ...
        print(f'Deformable Registration - alpha {self.alpha} beta {self.beta}, tolerance: {self.tolerance}')
    ...
    def set_registration_parameters(self, pickled_params):
        """
        Set the current deformable transformation parameters.

        """
        self.G, self.W = pickled_params