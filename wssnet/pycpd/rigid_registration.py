...
class RigidRegistration(EMRegistration):
    ...
    def __init__(self, R=None, t=None, s=None, *args, **kwargs):
        ...
        print(f'Rigid Registration, tolerance: {self.tolerance}')
    ...
    def update_transform(self):
        ...
        """
        # print("Rigid params:", self.get_registration_parameters())
    ...
    def update_variance(self):
        ...
        """
        # print("Update rigid variance:", self.get_registration_parameters())
        qprev = self.q
    ...
    def set_registration_parameters(self, pickled_params):
        """
        Set the rigid transformation parameters.

        """
        self.s, self.R, self.t = pickled_params
